...
<body>
    ...
    <section class="otrosProd">
        <div class="nuevosProd">
            <div class="titNuevoProd center">
                <h3>Nuevos Productos</h3>
            </div>
            <div class="productos row">
                <div class="producto col s6">
                    <div class="tituloProd center">
        ...
        <div class="prodDestacados">
            <div class="titulosDestados center">
